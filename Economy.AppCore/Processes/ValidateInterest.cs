...
namespace Economy.AppCore.Processes
{
...

    {
        ...
        //    //    return false;
        //    //}
        //    //else if (lists.Where(x => x. == (string)t.GetType().GetProperty("FlowType").GetValue(t) && x.Initial <= (int)t.GetType().GetProperty("Initial").GetValue(t) && (int)t.GetType().GetProperty("End").GetValue(t) <= x.End).ToList().Count > 0)
        //    //{
        //    //    return false;
        //    //}
